...
rm -rf $BUILD_IMG/output_kernel/Mystery-Kernel-S6-Edge-MM-*.tar
rm -rf $BUILD_IMG/output_kernel/Mystery-Kernel-S6-Edge-MM-*.zip
...
#echo "Make DT.img..........................."
#echo
#./tools/dtbtool -o $BUILD_IMG/boot_edge/dt.img -s 2048 -p ./scripts/dtc/ $DTS/ | sleep 1
...
cp $IMG/Image $BUILD_IMG/boot_edge/kernel

cd $BUILD_IMG

./mkboot boot_edge boot.img
...
echo "Make Clean..........................."
echo
rm -rf $BUILD_IMG/boot_edge/Image
rm -rf $BUILD_IMG/boot_edge/kernel
